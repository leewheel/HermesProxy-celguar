    ...
    public class ObjectUpdateBuilder
    {
        public ObjectUpdateBuilder(ObjectUpdate updateData, GameSessionData gameState)
        {
            ...
            if (objectType == Enums.ObjectType.Player && m_gameState.CurrentPlayerGuid == updateData.Guid)
                objectType = Enums.ObjectType.ActivePlayer;
            m_objectType = ObjectTypeConverter.ConvertToWotlk(objectType);
            ...
            switch (m_objectType)
            {
                case Enums.ObjectTypeWotlk.Item:
                    ...
                    break;
                case Enums.ObjectTypeWotlk.Container:
                    ...
                    break;
                case Enums.ObjectTypeWotlk.Unit:
                    ...
                    break;
                case Enums.ObjectTypeWotlk.Player:
                    ...
                    break;
                case Enums.ObjectTypeWotlk.ActivePlayer:
                    ...
                    break;
                case Enums.ObjectTypeWotlk.GameObject:
                    ...
                    break;
                case Enums.ObjectTypeWotlk.DynamicObject:
                    ...
                    break;
                case Enums.ObjectTypeWotlk.Corpse:
        ...
        protected Enums.ObjectTypeWotlk m_objectType;
        ...
        public void SetCreateObjectBits()
        {
            ...
            m_createBits.MovementTransport = m_updateData.CreateData != null & m_updateData.CreateData.MoveInfo != null && m_updateData.CreateData.MoveInfo.TransportGuid != null && m_objectType == Enums.ObjectTypeWotlk.GameObject;
            ...
            m_createBits.Rotation = m_updateData.CreateData != null & m_updateData.CreateData.MoveInfo != null && m_objectType == Enums.ObjectTypeWotlk.GameObject;
            m_createBits.ThisIsYou = m_createBits.ActivePlayer = m_objectType == Enums.ObjectTypeWotlk.ActivePlayer;
        }
        ...
        public void WriteValuesToArray()
        {
            ...
            if (activeData != null && m_objectType == Enums.ObjectTypeWotlk.ActivePlayer)
            {
                for (int i = 0; i < 23; i++)
                {
